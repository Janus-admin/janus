# Benchmark run — 2026-05-27T16-43-18Z
...
| Metric | Value |
|---|---:|
| Throughput | 20190.9014 req/s |
| Success rate (oha) | 100.00% |
| Latency p50 | 2.2868 ms |
| Latency p95 | 4.4759 ms |
| Latency p99 | 5.6405 ms |
| Total requests (Janus) | 1390001 |
| Cache hits (total) | 1389951 |
| Cache hits (exact) | 1389950 |
| Cache hits (semantic) | 1 |
| Cache misses (to provider) | 50 |
| Cache hit ratio | 1.000 |
| Errors (oha-reported) | 0 |
| CPU% (median, steady) | 216.0 |
| RSS peak (kB) | 1395232 |

## Provenance

```
# Frozen environment for run 2026-05-27T16-43-18Z
PROFILE=chat-long
DURATION=60s
CONCURRENCY=50
WARMUP_SECS=10
